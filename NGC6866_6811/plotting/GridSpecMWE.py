...
outdir = "/data/labs/douglste-laf-lab/wichmand/plots/SummaryGridSpec"
...
def plot_cmd(ax, star_id):
    ...
    if len(row) > 0:
        star_bp_rp = row["GAIAEDR3_BP"][0] - row["GAIAEDR3_RP"][0]
        star_G = row["GAIAEDR3_G"][0]
        star_dist = row["dist"][0]
...
def make_gridspec_plot(star_id, run_name):
    ...
    outname = f"{outdir}/Summary_{star_id}_{run_name}.png"
...
make_gridspec_plot(2075875655448396160, "200M")
make_gridspec_plot(2075875655448396160, "200M_jitter")
make_gridspec_plot(2128067445187794816, "200M_jitter_MCMC")
